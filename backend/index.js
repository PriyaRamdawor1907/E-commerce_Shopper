...
//Upload endpoint for images/ API to upload an image
app.use('/images', express.static('upload/images')) // make image accessible at http://localhost:4000/images/filename.jpg
...
//API to a add product to db
app.post('/addproduct', async (req, res) =>{
	let products = await Product.find({}); //fetch all docs from Product collection (the schema)
	let id;
...
//API to remove/delete a product from db
...
//API to retrieve all products from db
